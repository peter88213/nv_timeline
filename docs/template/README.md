[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_timeline/raw/main/dist/nv_timeline_v0.99.0.pyz)
...
- Launch *nv_timeline_v0.99.0.pyz* by double-clicking (Windows desktop),

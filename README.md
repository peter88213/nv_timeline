[![Download the latest release](docs/img/download-button.png)](https://github.com/peter88213/nv_timeline/raw/main/dist/nv_timeline_v5.3.1.pyz)
...
Download the latest release [nv_timeline_v5.3.1.pyz](https://github.com/peter88213/nv_timeline/raw/main/dist/nv_timeline_v5.3.1.pyz)

- Launch *nv_timeline_v5.3.1.pyz* by double-clicking (Windows/Linux desktop),
- or execute `python nv_timeline_v5.3.1.pyz` (Windows), resp. `python3 nv_timeline_v5.3.1.pyz` (Linux) on the command line.
